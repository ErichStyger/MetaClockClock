...
/* select the board used: */
#if 0 /* 60 billion time clock: 1x4 clock module */
  ...
  #define PL_CONFIG_USE_RTC             (0) /* RTC (at least software), for hardware add PL_CONFIG_USE_EXT_I2C_RTC */
  ...
  #define PL_CONFIG_USE_RS485           (0) /* turn off to save RAM & FLASH, but won't be able to communicate */
#endif
/* ********************************************************************* */
