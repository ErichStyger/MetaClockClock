...
WEAK void PIN_INT5_DAC1_IRQHandler(void);
WEAK void PIN_INT6_USART3_IRQHandler(void);
WEAK void PIN_INT7_USART4_IRQHandler(void);
...
void PIN_INT5_DAC1_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PIN_INT6_USART3_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
void PIN_INT7_USART4_DriverIRQHandler(void) ALIAS(IntDefaultHandler);
...
WEAK_AV void I2C2_IRQHandler(void)
{   I2C2_DriverIRQHandler();
}

WEAK_AV void I2C3_IRQHandler(void)
...
WEAK_AV void PIN_INT5_DAC1_IRQHandler(void)
{   PIN_INT5_DAC1_DriverIRQHandler();
}

WEAK_AV void PIN_INT6_USART3_IRQHandler(void)
{   PIN_INT6_USART3_DriverIRQHandler();
}

WEAK_AV void PIN_INT7_USART4_IRQHandler(void)
