...
#ifndef _FSL_CODEC_SGTL5000_ADAPTER_H_
#define _FSL_CODEC_SGTL5000_ADAPTER_H_

#include "fsl_sgtl5000.h"

/*!
 * @addtogroup sgtl5000_adapter
...
{
    return HAL_CODEC_SGTL5000_Init(handle, config);
}
...
{
    return HAL_CODEC_SGTL5000_Deinit(handle);
}
...
{
    return HAL_CODEC_SGTL5000_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_SGTL5000_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_SGTL5000_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_SGTL5000_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_SGTL5000_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_SGTL5000_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_SGTL5000_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_SGTL5000_ModuleControl(handle, cmd, data);
}
#endif
#if defined(__cplusplus)
}
...
#endif /* _FSL_CODEC_SGTL5000_ADAPTER_H_ */
