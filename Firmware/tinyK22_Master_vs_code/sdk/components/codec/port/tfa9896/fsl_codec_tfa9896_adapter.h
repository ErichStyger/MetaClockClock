...
#ifndef _FSL_CODEC_TFA9896_ADAPTER_H_
#define _FSL_CODEC_TFA9896_ADAPTER_H_

#include "fsl_tfa9896.h"

/*!
 * @addtogroup tfa9896_adapter
...
{
    return HAL_CODEC_TFA9896_Init(handle, config);
}
...
{
    return HAL_CODEC_TFA9896_Deinit(handle);
}
...
{
    return HAL_CODEC_TFA9896_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_TFA9896_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_TFA9896_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_TFA9896_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_TFA9896_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_TFA9896_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_TFA9896_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_TFA9896_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_TFA9896_ADAPTER_H_ */
