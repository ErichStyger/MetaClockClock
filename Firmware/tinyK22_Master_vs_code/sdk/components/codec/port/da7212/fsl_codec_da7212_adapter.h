...
#ifndef _FSL_CODEC_DA7212_ADAPTER_H_
#define _FSL_CODEC_DA7212_ADAPTER_H_

#include "fsl_dialog7212.h"

/*!
 * @addtogroup da7212_adapter
...
{
    return HAL_CODEC_DA7212_Init(handle, config);
}
...
{
    return HAL_CODEC_DA7212_Deinit(handle);
}
...
{
    return HAL_CODEC_DA7212_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_DA7212_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_DA7212_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_DA7212_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_DA7212_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_DA7212_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_DA7212_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_DA7212_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_DA7212_ADAPTER_H_ */
