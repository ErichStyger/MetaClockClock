...
#ifndef _FSL_CODEC_TFA9XXX_ADAPTER_H_
#define _FSL_CODEC_TFA9XXX_ADAPTER_H_
...
#define HAL_CODEC_TFA98XX_HANDLER_SIZE (TFA9XXX_I2C_HANDLER_SIZE + 4)
/*******************************************************************************
 * API
 ******************************************************************************/
...
{
    return HAL_CODEC_TFA9XXX_Init(handle, config);
}
...
{
    return HAL_CODEC_TFA9XXX_Deinit(handle);
}
...
{
    return HAL_CODEC_TFA9XXX_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_TFA9XXX_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_TFA9XXX_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_TFA9XXX_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_TFA9XXX_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_TFA9XXX_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_TFA9XXX_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_TFA9XXX_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_TFA9XXX_ADAPTER_H_ */
