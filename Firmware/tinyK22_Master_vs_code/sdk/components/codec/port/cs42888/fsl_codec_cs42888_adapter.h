...
#ifndef _FSL_CODEC_CS42888_ADAPTER_H_
#define _FSL_CODEC_CS42888_ADAPTER_H_
...
{
    return HAL_CODEC_CS42888_Init(handle, config);
}
...
{
    return HAL_CODEC_CS42888_Deinit(handle);
}
...
{
    return HAL_CODEC_CS42888_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_CS42888_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_CS42888_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_CS42888_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_CS42888_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_CS42888_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_CS42888_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_CS42888_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_CS42888_ADAPTER_H_ */
