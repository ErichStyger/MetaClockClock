...
#ifndef _FSL_CODEC_PCM512X_ADAPTER_H_
#define _FSL_CODEC_PCM512X_ADAPTER_H_

#include "fsl_pcm512x.h"

/*!
 * @addtogroup pcm512x_adapter
...
#define HAL_CODEC_PCM512X_HANDLER_SIZE (PCM512X_I2C_HANDLER_SIZE + 8)
/*******************************************************************************
 * API
 ******************************************************************************/
 ...
 */
status_t HAL_CODEC_PCM512x_Init(void *handle, void *config);
 ...
 */
status_t HAL_CODEC_PCM512x_Deinit(void *handle);
 ...
 */
status_t HAL_CODEC_PCM512x_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t bitWidth);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetVolume(void *handle, uint32_t playChannel, uint32_t volume);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetMute(void *handle, uint32_t playChannel, bool isMute);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetPower(void *handle, uint32_t module, bool powerOn);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetRecord(void *handle, uint32_t recordSource);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetRecordChannel(void *handle, uint32_t leftRecordChannel, uint32_t rightRecordChannel);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_SetPlay(void *handle, uint32_t playSource);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_PCM512x_ModuleControl(void *handle, uint32_t cmd, uint32_t data);
...
{
    return HAL_CODEC_PCM512x_Init(handle, config);
}
...
{
    return HAL_CODEC_PCM512x_Deinit(handle);
}
...
{
    return HAL_CODEC_PCM512x_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_PCM512x_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_PCM512x_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_PCM512x_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_PCM512x_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_PCM512x_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_PCM512x_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_PCM512x_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_PCM512X_ADAPTER_H_ */
