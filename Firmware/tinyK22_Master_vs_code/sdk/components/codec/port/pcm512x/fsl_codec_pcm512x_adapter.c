 ...
 * Variables
 ******************************************************************************/
static const codec_capability_t s_pcm512x_capability;
/*******************************************************************************
 * Code
 ******************************************************************************/
/*!
...
status_t HAL_CODEC_PCM512x_Init(void *handle, void *config)
{
    ...
    pcm512x_config_t *devConfig = (pcm512x_config_t *)(codecConfig->codecDevConfig);
    pcm512x_handle_t *devHandle = (pcm512x_handle_t *)((uintptr_t)(((codec_handle_t *)handle)->codecDevHandle));

    ((codec_handle_t *)handle)->codecCapability = &s_pcm512x_capability;

    /* codec device initialization */
    return PCM512x_Init(devHandle, devConfig);
}
...
status_t HAL_CODEC_PCM512x_Deinit(void *handle)
{
    ...
    return PCM512x_Deinit(devHandle);
}
...
status_t HAL_CODEC_PCM512x_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t bitWidth)
{
    ...
    return PCM512x_SetFormat(devHandle, mclk, sampleRate, bitWidth);
}
...
status_t HAL_CODEC_PCM512x_SetMute(void *handle, uint32_t playChannel, bool isMute)
{
    ...
    ret = PCM512x_SetMute((pcm512x_handle_t *)((uintptr_t)(((codec_handle_t *)handle)->codecDevHandle)), isMute);
