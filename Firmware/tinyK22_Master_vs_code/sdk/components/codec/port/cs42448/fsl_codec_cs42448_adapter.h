...
#ifndef _FSL_CODEC_CS42448_ADAPTER_H_
#define _FSL_CODEC_CS42448_ADAPTER_H_

#include "fsl_cs42448.h"

/*!
 * @addtogroup cs42448_adapter
...
#define HAL_CODEC_CS42448_HANDLER_SIZE (CS42448_I2C_HANDLER_SIZE + 4)
/*******************************************************************************
 * API
 ******************************************************************************/
...
{
    return HAL_CODEC_CS42448_Init(handle, config);
}
...
{
    return HAL_CODEC_CS42448_Deinit(handle);
}
...
{
    return HAL_CODEC_CS42448_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_CS42448_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_CS42448_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_CS42448_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_CS42448_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_CS42448_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_CS42448_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_CS42448_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_CS42448_ADAPTER_H_ */
