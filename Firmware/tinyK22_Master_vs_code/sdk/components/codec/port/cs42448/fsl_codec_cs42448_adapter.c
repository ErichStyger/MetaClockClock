 ...
 * Definitions
 ******************************************************************************/
/*! @brief CS42448 play capability*/
#define HAL_CS42448_PLAY_CAPABILITY                                                                          \
...
#define HAL_CS42448_VOLUME_CAPABILITY                                                                        \
    kCODEC_SupportPlayChannelLeft0 | kCODEC_SupportPlayChannelRight0 | kCODEC_SupportPlayChannelLeft1 |      \
        kCODEC_SupportPlayChannelRight1 | kCODEC_SupportPlayChannelLeft2 | kCODEC_SupportPlayChannelRight2 | \
        kCODEC_SupportPlayChannelLeft3 | kCODEC_SupportPlayChannelRight3
/*******************************************************************************
 ...
 * Variables
 ******************************************************************************/
static const codec_capability_t s_cs42448_capability = {
    .codecPlayCapability   = HAL_CS42448_PLAY_CAPABILITY,
    .codecVolumeCapability = HAL_CS42448_VOLUME_CAPABILITY,
};
/*******************************************************************************
 * Code
 ******************************************************************************/
...
status_t HAL_CODEC_CS42448_Init(void *handle, void *config)
{
    ...
    cs42448_config_t *devConfig = (cs42448_config_t *)(codecConfig->codecDevConfig);
    cs42448_handle_t *devHandle = (cs42448_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle));

    /* load codec capability */
    ((codec_handle_t *)handle)->codecCapability = &s_cs42448_capability;
    /* codec device initialization */
    ret = CS42448_Init(devHandle, devConfig);
...
status_t HAL_CODEC_CS42448_Deinit(void *handle)
{
    ...
    return CS42448_Deinit((cs42448_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)));
}
 ...
 */
status_t HAL_CODEC_CS42448_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t bitWidth)
{
    assert(handle != NULL);

    return CS42448_ConfigDataFormat((cs42448_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)), mclk,
                                    sampleRate, bitWidth);
}
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_SetVolume(void *handle, uint32_t playChannel, uint32_t volume)
{
    assert(handle != NULL);
    uint8_t i            = 0U;
    status_t ret         = kStatus_Success;
    ...
    for (i = 0U; i < (uint8_t)kCS42448_AOUT8; i++)
    {
        ...
        if (volume == 0U)
        {
            ret = CS42448_SetChannelMute((cs42448_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)),
                                         (uint8_t)(i + 1U), true);
        }
        else
        {
            ...
            {
                ret =
                    CS42448_SetChannelMute((cs42448_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)),
                                           (uint8_t)(i + 1U), false);
            }
        }
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_SetPower(void *handle, uint32_t module, bool powerOn)
{
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_SetRecord(void *handle, uint32_t recordSource)
{
    return kStatus_CODEC_NotSupport;
}
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_SetRecordChannel(void *handle, uint32_t leftRecordChannel, uint32_t rightRecordChannel)
{
    return kStatus_CODEC_NotSupport;
}
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_SetPlay(void *handle, uint32_t playSource)
{
    return kStatus_CODEC_NotSupport;
}
 ...
 * return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_CS42448_ModuleControl(void *handle, uint32_t cmd, uint32_t data)
{
    return kStatus_CODEC_NotSupport;
}
