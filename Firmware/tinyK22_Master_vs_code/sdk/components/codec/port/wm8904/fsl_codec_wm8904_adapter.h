...
#ifndef _FSL_CODEC_WM8904_ADAPTER_H_
#define _FSL_CODEC_WM8904_ADAPTER_H_
...
{
    return HAL_CODEC_WM8904_Init(handle, config);
}
...
{
    return HAL_CODEC_WM8904_Deinit(handle);
}
...
{
    return HAL_CODEC_WM8904_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_WM8904_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_WM8904_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_WM8904_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_WM8904_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_WM8904_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_WM8904_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_WM8904_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_WM8904_ADAPTER_H_ */
