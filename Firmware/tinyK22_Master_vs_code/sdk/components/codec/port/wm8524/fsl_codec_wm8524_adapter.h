...
#ifndef _FSL_CODEC_WM8524_ADAPTER_H_
#define _FSL_CODEC_WM8524_ADAPTER_H_

#include "fsl_wm8524.h"

/*!
 * @addtogroup wm8524_adapter
...
{
    return HAL_CODEC_WM8524_Init(handle, config);
}
...
{
    return HAL_CODEC_WM8524_Deinit(handle);
}
...
{
    return HAL_CODEC_WM8524_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_WM8524_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_WM8524_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_WM8524_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_WM8524_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_WM8524_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_WM8524_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_WM8524_ModuleControl(handle, cmd, data);
}
#endif
...
#endif /* _FSL_CODEC_WM8524_ADAPTER_H_ */
