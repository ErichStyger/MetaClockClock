...
usb_device_interface_struct_t g_UsbDeviceCdcVcomCommunicationInterface[] = {{USB_CDC_VCOM_COMM_INTERFACE_ALTERNATE_0,
                                                                             {
...
usb_device_interface_struct_t g_UsbDeviceCdcVcomDataInterface[] = {{USB_CDC_VCOM_DATA_INTERFACE_ALTERNATE_0,
                                                                    {
...
/* Total length of data returned for this configuration. */
    ...
    USB_DESCRIPTOR_LENGTH_INTERFACE, USB_DESCRIPTOR_TYPE_INTERFACE, USB_CDC_VCOM_COMM_INTERFACE_INDEX,
    USB_CDC_VCOM_COMM_INTERFACE_ALTERNATE_0, USB_CDC_VCOM_ENDPOINT_CIC_COUNT, USB_CDC_VCOM_CIC_CLASS,
    USB_CDC_VCOM_CIC_SUBCLASS, USB_CDC_VCOM_CIC_PROTOCOL, 0x00, /* Interface Description String Index*/
    ...
    USB_DESCRIPTOR_LENGTH_INTERFACE, USB_DESCRIPTOR_TYPE_INTERFACE, USB_CDC_VCOM_DATA_INTERFACE_INDEX,
    USB_CDC_VCOM_DATA_INTERFACE_ALTERNATE_0, USB_CDC_VCOM_ENDPOINT_DIC_COUNT, USB_CDC_VCOM_DIC_CLASS,
