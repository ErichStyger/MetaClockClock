...
#if defined(FMSTR_CAN_DRV) && (FMSTR_MK_IDSTR(FMSTR_CAN_DRV) == FMSTR_CAN_MCUX_FLEXCAN_ID)
...
static FMSTR_SIZE8 _FMSTR_FlexCAN_GetRxFrameLen(void)
{
    ...
    return (FMSTR_SIZE8)fmstr_rxmsg.length;
}
...
#endif /* (!(FMSTR_DISABLE)) */
#endif /* defined(FMSTR_CAN_DRV) && (FMSTR_MK_IDSTR(FMSTR_CAN_DRV) == FMSTR_CAN_MCUX_FLEXCAN_ID) */
