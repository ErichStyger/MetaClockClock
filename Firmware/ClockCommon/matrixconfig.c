...
#include "matrix.h"
  ...
  const MatrixClock_t clockMatrix[MATRIX_NOF_CLOCKS_X][MATRIX_NOF_CLOCKS_Y] = /* information about how the clocks are organized */
  {
    ...
    [4][3]={.addr=BOARD_ADDR_12, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][3]={.addr=BOARD_ADDR_11, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][3]={.addr=BOARD_ADDR_12, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][3]={.addr=BOARD_ADDR_12, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    [4][4]={.addr=BOARD_ADDR_13, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][4]={.addr=BOARD_ADDR_12, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][4]={.addr=BOARD_ADDR_13, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][4]={.addr=BOARD_ADDR_13, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    [4][5]={.addr=BOARD_ADDR_14, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][5]={.addr=BOARD_ADDR_13, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][5]={.addr=BOARD_ADDR_14, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][5]={.addr=BOARD_ADDR_14, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    [4][6]={.addr=BOARD_ADDR_15, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][6]={.addr=BOARD_ADDR_14, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][6]={.addr=BOARD_ADDR_15, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][6]={.addr=BOARD_ADDR_15, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    [4][7]={.addr=BOARD_ADDR_16, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][7]={.addr=BOARD_ADDR_15, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][7]={.addr=BOARD_ADDR_16, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][7]={.addr=BOARD_ADDR_16, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    [4][8]={.addr=BOARD_ADDR_17, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [5][8]={.addr=BOARD_ADDR_16, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [6][8]={.addr=BOARD_ADDR_17, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [7][8]={.addr=BOARD_ADDR_17, .nr=0, .board.x=3, .board.y=0, .enabled=true},
    ...
    [13][8]={.addr=BOARD_ADDR_35, .nr=3, .board.x=0, .board.y=0, .enabled=true}, [13][8]={.addr=BOARD_ADDR_35, .nr=2, .board.x=1, .board.y=0, .enabled=true}, [14][8]={.addr=BOARD_ADDR_35, .nr=1, .board.x=2, .board.y=0, .enabled=true}, [15][8]={.addr=BOARD_ADDR_35, .nr=0, .board.x=3, .board.y=0, .enabled=true},
};
