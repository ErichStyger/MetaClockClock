...
#include "matrix.h"
  ...
  const MatrixClock_t clockMatrix[MATRIX_NOF_STEPPERS_X][MATRIX_NOF_STEPPERS_Y][MATRIX_NOF_STEPPERS_Z] = /* information about how the clocks are organized */
  {
    ...
    [2][0][0]={.addr=BOARD_ADDR_10, .board.x=0, .board.y=0, .board.z=0}, [2][0][1]={.addr=BOARD_ADDR_10, .board.x=0, .board.y=0, .board.z=1},
    [2][1][0]={.addr=BOARD_ADDR_11, .board.x=0, .board.y=0, .board.z=0}, [2][1][1]={.addr=BOARD_ADDR_11, .board.x=0, .board.y=0, .board.z=1},
    [2][2][0]={.addr=BOARD_ADDR_12, .board.x=0, .board.y=0, .board.z=0}, [2][2][1]={.addr=BOARD_ADDR_12, .board.x=0, .board.y=0, .board.z=1},
    [2][3][0]={.addr=BOARD_ADDR_13, .board.x=0, .board.y=0, .board.z=0}, [2][3][1]={.addr=BOARD_ADDR_13, .board.x=0, .board.y=0, .board.z=1},
    [2][4][0]={.addr=BOARD_ADDR_14, .board.x=0, .board.y=0, .board.z=0}, [2][4][1]={.addr=BOARD_ADDR_14, .board.x=0, .board.y=0, .board.z=1},

    [3][0][0]={.addr=BOARD_ADDR_10, .board.x=1, .board.y=0, .board.z=0}, [3][0][1]={.addr=BOARD_ADDR_10, .board.x=1, .board.y=0, .board.z=1},
    [3][1][0]={.addr=BOARD_ADDR_11, .board.x=1, .board.y=0, .board.z=0}, [3][1][1]={.addr=BOARD_ADDR_11, .board.x=1, .board.y=0, .board.z=1},
    [3][2][0]={.addr=BOARD_ADDR_12, .board.x=1, .board.y=0, .board.z=0}, [3][2][1]={.addr=BOARD_ADDR_12, .board.x=1, .board.y=0, .board.z=1},
    [3][3][0]={.addr=BOARD_ADDR_13, .board.x=1, .board.y=0, .board.z=0}, [3][3][1]={.addr=BOARD_ADDR_13, .board.x=1, .board.y=0, .board.z=1},
    [3][4][0]={.addr=BOARD_ADDR_14, .board.x=1, .board.y=0, .board.z=0}, [3][4][1]={.addr=BOARD_ADDR_14, .board.x=1, .board.y=0, .board.z=1},

    [4][0][0]={.addr=BOARD_ADDR_20, .board.x=0, .board.y=0, .board.z=0}, [4][0][1]={.addr=BOARD_ADDR_20, .board.x=0, .board.y=0, .board.z=1},
    [4][1][0]={.addr=BOARD_ADDR_21, .board.x=0, .board.y=0, .board.z=0}, [4][1][1]={.addr=BOARD_ADDR_21, .board.x=0, .board.y=0, .board.z=1},
    [4][2][0]={.addr=BOARD_ADDR_22, .board.x=0, .board.y=0, .board.z=0}, [4][2][1]={.addr=BOARD_ADDR_22, .board.x=0, .board.y=0, .board.z=1},
    [4][3][0]={.addr=BOARD_ADDR_23, .board.x=0, .board.y=0, .board.z=0}, [4][3][1]={.addr=BOARD_ADDR_23, .board.x=0, .board.y=0, .board.z=1},
    [4][4][0]={.addr=BOARD_ADDR_24, .board.x=0, .board.y=0, .board.z=0}, [4][4][1]={.addr=BOARD_ADDR_24, .board.x=0, .board.y=0, .board.z=1},

    [5][0][0]={.addr=BOARD_ADDR_20, .board.x=1, .board.y=0, .board.z=0}, [5][0][1]={.addr=BOARD_ADDR_20, .board.x=1, .board.y=0, .board.z=1},
    [5][1][0]={.addr=BOARD_ADDR_21, .board.x=1, .board.y=0, .board.z=0}, [5][1][1]={.addr=BOARD_ADDR_21, .board.x=1, .board.y=0, .board.z=1},
    [5][2][0]={.addr=BOARD_ADDR_22, .board.x=1, .board.y=0, .board.z=0}, [5][2][1]={.addr=BOARD_ADDR_22, .board.x=1, .board.y=0, .board.z=1},
    [5][3][0]={.addr=BOARD_ADDR_23, .board.x=1, .board.y=0, .board.z=0}, [5][3][1]={.addr=BOARD_ADDR_23, .board.x=1, .board.y=0, .board.z=1},
    [5][4][0]={.addr=BOARD_ADDR_24, .board.x=1, .board.y=0, .board.z=0}, [5][4][1]={.addr=BOARD_ADDR_24, .board.x=1, .board.y=0, .board.z=1},

    [6][0][0]={.addr=BOARD_ADDR_30, .board.x=0, .board.y=0, .board.z=0}, [6][0][1]={.addr=BOARD_ADDR_30, .board.x=0, .board.y=0, .board.z=1},
    [6][1][0]={.addr=BOARD_ADDR_31, .board.x=0, .board.y=0, .board.z=0}, [6][1][1]={.addr=BOARD_ADDR_31, .board.x=0, .board.y=0, .board.z=1},
    [6][2][0]={.addr=BOARD_ADDR_32, .board.x=0, .board.y=0, .board.z=0}, [6][2][1]={.addr=BOARD_ADDR_32, .board.x=0, .board.y=0, .board.z=1},
    [6][3][0]={.addr=BOARD_ADDR_33, .board.x=0, .board.y=0, .board.z=0}, [6][3][1]={.addr=BOARD_ADDR_33, .board.x=0, .board.y=0, .board.z=1},
    [6][4][0]={.addr=BOARD_ADDR_34, .board.x=0, .board.y=0, .board.z=0}, [6][4][1]={.addr=BOARD_ADDR_34, .board.x=0, .board.y=0, .board.z=1},

    [7][0][0]={.addr=BOARD_ADDR_30, .board.x=1, .board.y=0, .board.z=0}, [7][0][1]={.addr=BOARD_ADDR_30, .board.x=1, .board.y=0, .board.z=1},
    [7][1][0]={.addr=BOARD_ADDR_31, .board.x=1, .board.y=0, .board.z=0}, [7][1][1]={.addr=BOARD_ADDR_31, .board.x=1, .board.y=0, .board.z=1},
    [7][2][0]={.addr=BOARD_ADDR_32, .board.x=1, .board.y=0, .board.z=0}, [7][2][1]={.addr=BOARD_ADDR_32, .board.x=1, .board.y=0, .board.z=1},
    [7][3][0]={.addr=BOARD_ADDR_33, .board.x=1, .board.y=0, .board.z=0}, [7][3][1]={.addr=BOARD_ADDR_33, .board.x=1, .board.y=0, .board.z=1},
    [7][4][0]={.addr=BOARD_ADDR_34, .board.x=1, .board.y=0, .board.z=0}, [7][4][1]={.addr=BOARD_ADDR_34, .board.x=1, .board.y=0, .board.z=1},

    [8][0][0]={.addr=BOARD_ADDR_40, .board.x=0, .board.y=0, .board.z=0}, [8][0][1]={.addr=BOARD_ADDR_40, .board.x=0, .board.y=0, .board.z=1},
    [8][1][0]={.addr=BOARD_ADDR_41, .board.x=0, .board.y=0, .board.z=0}, [8][1][1]={.addr=BOARD_ADDR_41, .board.x=0, .board.y=0, .board.z=1},
    [8][2][0]={.addr=BOARD_ADDR_42, .board.x=0, .board.y=0, .board.z=0}, [8][2][1]={.addr=BOARD_ADDR_42, .board.x=0, .board.y=0, .board.z=1},
    [8][3][0]={.addr=BOARD_ADDR_43, .board.x=0, .board.y=0, .board.z=0}, [8][3][1]={.addr=BOARD_ADDR_43, .board.x=0, .board.y=0, .board.z=1},
    [8][4][0]={.addr=BOARD_ADDR_44, .board.x=0, .board.y=0, .board.z=0}, [8][4][1]={.addr=BOARD_ADDR_44, .board.x=0, .board.y=0, .board.z=1},

    [9][0][0]={.addr=BOARD_ADDR_40, .board.x=1, .board.y=0, .board.z=0}, [9][0][1]={.addr=BOARD_ADDR_40, .board.x=1, .board.y=0, .board.z=1},
    [9][1][0]={.addr=BOARD_ADDR_41, .board.x=1, .board.y=0, .board.z=0}, [9][1][1]={.addr=BOARD_ADDR_41, .board.x=1, .board.y=0, .board.z=1},
    [9][2][0]={.addr=BOARD_ADDR_42, .board.x=1, .board.y=0, .board.z=0}, [9][2][1]={.addr=BOARD_ADDR_42, .board.x=1, .board.y=0, .board.z=1},
    [9][3][0]={.addr=BOARD_ADDR_43, .board.x=1, .board.y=0, .board.z=0}, [9][3][1]={.addr=BOARD_ADDR_43, .board.x=1, .board.y=0, .board.z=1},
    [9][4][0]={.addr=BOARD_ADDR_44, .board.x=1, .board.y=0, .board.z=0}, [9][4][1]={.addr=BOARD_ADDR_44, .board.x=1, .board.y=0, .board.z=1},

    [10][0][0]={.addr=BOARD_ADDR_50, .board.x=0, .board.y=0, .board.z=0},[10][0][1]={.addr=BOARD_ADDR_50, .board.x=0, .board.y=0, .board.z=1},
    [10][1][0]={.addr=BOARD_ADDR_51, .board.x=0, .board.y=0, .board.z=0},[10][1][1]={.addr=BOARD_ADDR_51, .board.x=0, .board.y=0, .board.z=1},
    [10][2][0]={.addr=BOARD_ADDR_52, .board.x=0, .board.y=0, .board.z=0},[10][2][1]={.addr=BOARD_ADDR_52, .board.x=0, .board.y=0, .board.z=1},
    [10][3][0]={.addr=BOARD_ADDR_53, .board.x=0, .board.y=0, .board.z=0},[10][3][1]={.addr=BOARD_ADDR_53, .board.x=0, .board.y=0, .board.z=1},
    [10][4][0]={.addr=BOARD_ADDR_54, .board.x=0, .board.y=0, .board.z=0},[10][4][1]={.addr=BOARD_ADDR_54, .board.x=0, .board.y=0, .board.z=1},

    [11][0][0]={.addr=BOARD_ADDR_50, .board.x=1, .board.y=0, .board.z=0},[11][0][1]={.addr=BOARD_ADDR_50, .board.x=1, .board.y=0, .board.z=1},
    [11][1][0]={.addr=BOARD_ADDR_51, .board.x=1, .board.y=0, .board.z=0},[11][1][1]={.addr=BOARD_ADDR_51, .board.x=1, .board.y=0, .board.z=1},
    [11][2][0]={.addr=BOARD_ADDR_52, .board.x=1, .board.y=0, .board.z=0},[11][2][1]={.addr=BOARD_ADDR_52, .board.x=1, .board.y=0, .board.z=1},
    [11][3][0]={.addr=BOARD_ADDR_53, .board.x=1, .board.y=0, .board.z=0},[11][3][1]={.addr=BOARD_ADDR_53, .board.x=1, .board.y=0, .board.z=1},
    [11][4][0]={.addr=BOARD_ADDR_54, .board.x=1, .board.y=0, .board.z=0},[11][4][1]={.addr=BOARD_ADDR_54, .board.x=1, .board.y=0, .board.z=1},
};
  ...
  MATRIX_BoardList_t MATRIX_BoardList[MATRIX_NOF_BOARDS] = {
      ...
      {.addr=BOARD_ADDR_40, .cmdSent=false},
      ...
      {.addr=BOARD_ADDR_50, .cmdSent=false},
  ...
  const MatrixClock_t clockMatrix[MATRIX_NOF_STEPPERS_X][MATRIX_NOF_STEPPERS_Y][MATRIX_NOF_STEPPERS_Z] = /* information about how the clocks are organized */
  {
        ...
        [8][0][0]={.addr=BOARD_ADDR_00, .board.x=8, .board.y=0, .board.z=0},
        [9][0][0]={.addr=BOARD_ADDR_00, .board.x=9, .board.y=0, .board.z=0},
        [10][0][0]={.addr=BOARD_ADDR_00, .board.x=10, .board.y=0, .board.z=0},
        [11][0][0]={.addr=BOARD_ADDR_00, .board.x=11, .board.y=0, .board.z=0},
        [12][0][0]={.addr=BOARD_ADDR_00, .board.x=12, .board.y=0, .board.z=0},
        [13][0][0]={.addr=BOARD_ADDR_00, .board.x=13, .board.y=0, .board.z=0},
        [14][0][0]={.addr=BOARD_ADDR_00, .board.x=14, .board.y=0, .board.z=0},
        [15][0][0]={.addr=BOARD_ADDR_00, .board.x=15, .board.y=0, .board.z=0},

        /* 2nd row */
        [0][1][0]={.addr=BOARD_ADDR_00, .board.x=0, .board.y=1, .board.z=0},
        [1][1][0]={.addr=BOARD_ADDR_00, .board.x=1, .board.y=1, .board.z=0},
        [2][1][0]={.addr=BOARD_ADDR_00, .board.x=2, .board.y=1, .board.z=0},
        [3][1][0]={.addr=BOARD_ADDR_00, .board.x=3, .board.y=1, .board.z=0},
        [4][1][0]={.addr=BOARD_ADDR_00, .board.x=4, .board.y=1, .board.z=0},
        [5][1][0]={.addr=BOARD_ADDR_00, .board.x=5, .board.y=1, .board.z=0},
        [6][1][0]={.addr=BOARD_ADDR_00, .board.x=6, .board.y=1, .board.z=0},
        [7][1][0]={.addr=BOARD_ADDR_00, .board.x=7, .board.y=1, .board.z=0},
        [8][1][0]={.addr=BOARD_ADDR_00, .board.x=8, .board.y=1, .board.z=0},
        [9][1][0]={.addr=BOARD_ADDR_00, .board.x=9, .board.y=1, .board.z=0},
        [10][1][0]={.addr=BOARD_ADDR_00, .board.x=10, .board.y=1, .board.z=0},
        [11][1][0]={.addr=BOARD_ADDR_00, .board.x=11, .board.y=1, .board.z=0},
        [12][1][0]={.addr=BOARD_ADDR_00, .board.x=12, .board.y=1, .board.z=0},
        [13][1][0]={.addr=BOARD_ADDR_00, .board.x=13, .board.y=1, .board.z=0},
        [14][1][0]={.addr=BOARD_ADDR_00, .board.x=14, .board.y=1, .board.z=0},
        [15][1][0]={.addr=BOARD_ADDR_00, .board.x=15, .board.y=1, .board.z=0},

        /* 3rd row */
        [0][2][0]={.addr=BOARD_ADDR_00, .board.x=0, .board.y=2, .board.z=0},
        [1][2][0]={.addr=BOARD_ADDR_00, .board.x=1, .board.y=2, .board.z=0},
        [2][2][0]={.addr=BOARD_ADDR_00, .board.x=2, .board.y=2, .board.z=0},
        [3][2][0]={.addr=BOARD_ADDR_00, .board.x=3, .board.y=2, .board.z=0},
        [4][2][0]={.addr=BOARD_ADDR_00, .board.x=4, .board.y=2, .board.z=0},
        [5][2][0]={.addr=BOARD_ADDR_00, .board.x=5, .board.y=2, .board.z=0},
        [6][2][0]={.addr=BOARD_ADDR_00, .board.x=6, .board.y=2, .board.z=0},
        [7][2][0]={.addr=BOARD_ADDR_00, .board.x=7, .board.y=2, .board.z=0},
        [8][2][0]={.addr=BOARD_ADDR_00, .board.x=8, .board.y=2, .board.z=0},
        [9][2][0]={.addr=BOARD_ADDR_00, .board.x=9, .board.y=2, .board.z=0},
        [10][2][0]={.addr=BOARD_ADDR_00, .board.x=10, .board.y=2, .board.z=0},
        [11][2][0]={.addr=BOARD_ADDR_00, .board.x=11, .board.y=2, .board.z=0},
        [12][2][0]={.addr=BOARD_ADDR_00, .board.x=12, .board.y=2, .board.z=0},
        [13][2][0]={.addr=BOARD_ADDR_00, .board.x=13, .board.y=2, .board.z=0},
        [14][2][0]={.addr=BOARD_ADDR_00, .board.x=14, .board.y=2, .board.z=0},
        [15][2][0]={.addr=BOARD_ADDR_00, .board.x=15, .board.y=2, .board.z=0},

        /* 4th row */
        [0][3][0]={.addr=BOARD_ADDR_00, .board.x=0, .board.y=3, .board.z=0},
        [1][3][0]={.addr=BOARD_ADDR_00, .board.x=1, .board.y=3, .board.z=0},
        [2][3][0]={.addr=BOARD_ADDR_00, .board.x=2, .board.y=3, .board.z=0},
        [3][3][0]={.addr=BOARD_ADDR_00, .board.x=3, .board.y=3, .board.z=0},
        [4][3][0]={.addr=BOARD_ADDR_00, .board.x=4, .board.y=3, .board.z=0},
        [5][3][0]={.addr=BOARD_ADDR_00, .board.x=5, .board.y=3, .board.z=0},
        [6][3][0]={.addr=BOARD_ADDR_00, .board.x=6, .board.y=3, .board.z=0},
        [7][3][0]={.addr=BOARD_ADDR_00, .board.x=7, .board.y=3, .board.z=0},
        [8][3][0]={.addr=BOARD_ADDR_00, .board.x=8, .board.y=3, .board.z=0},
        [9][3][0]={.addr=BOARD_ADDR_00, .board.x=9, .board.y=3, .board.z=0},
        [10][3][0]={.addr=BOARD_ADDR_00, .board.x=10, .board.y=3, .board.z=0},
        [11][3][0]={.addr=BOARD_ADDR_00, .board.x=11, .board.y=3, .board.z=0},
        [12][3][0]={.addr=BOARD_ADDR_00, .board.x=12, .board.y=3, .board.z=0},
        [13][3][0]={.addr=BOARD_ADDR_00, .board.x=13, .board.y=3, .board.z=0},
        [14][3][0]={.addr=BOARD_ADDR_00, .board.x=14, .board.y=3, .board.z=0},
        [15][3][0]={.addr=BOARD_ADDR_00, .board.x=15, .board.y=3, .board.z=0},

        /* 5th row */
        [0][4][0]={.addr=BOARD_ADDR_00, .board.x=0, .board.y=4, .board.z=0},
        [1][4][0]={.addr=BOARD_ADDR_00, .board.x=1, .board.y=4, .board.z=0},
        [2][4][0]={.addr=BOARD_ADDR_00, .board.x=2, .board.y=4, .board.z=0},
        [3][4][0]={.addr=BOARD_ADDR_00, .board.x=3, .board.y=4, .board.z=0},
        [4][4][0]={.addr=BOARD_ADDR_00, .board.x=4, .board.y=4, .board.z=0},
        [5][4][0]={.addr=BOARD_ADDR_00, .board.x=5, .board.y=4, .board.z=0},
        [6][4][0]={.addr=BOARD_ADDR_00, .board.x=6, .board.y=4, .board.z=0},
        [7][4][0]={.addr=BOARD_ADDR_00, .board.x=7, .board.y=4, .board.z=0},
        [8][4][0]={.addr=BOARD_ADDR_00, .board.x=8, .board.y=4, .board.z=0},
        [9][4][0]={.addr=BOARD_ADDR_00, .board.x=9, .board.y=4, .board.z=0},
        [10][4][0]={.addr=BOARD_ADDR_00, .board.x=10, .board.y=4, .board.z=0},
        [11][4][0]={.addr=BOARD_ADDR_00, .board.x=11, .board.y=4, .board.z=0},
        [12][4][0]={.addr=BOARD_ADDR_00, .board.x=12, .board.y=4, .board.z=0},
        [13][4][0]={.addr=BOARD_ADDR_00, .board.x=13, .board.y=4, .board.z=0},
        [14][4][0]={.addr=BOARD_ADDR_00, .board.x=14, .board.y=4, .board.z=0},
        [15][4][0]={.addr=BOARD_ADDR_00, .board.x=15, .board.y=4, .board.z=0},
    };
    ...
    const MatrixClock_t clockMatrix[MATRIX_NOF_STEPPERS_X][MATRIX_NOF_STEPPERS_Y][MATRIX_NOF_STEPPERS_Z] = /* information about how the clocks are organized */
    {
      ...
      [0][3][0]={.addr=BOARD_ADDR_03, .board.x=0, .board.y=0, .board.z=0}, [0][3][1]={.addr=BOARD_ADDR_03, .board.x=0, .board.y=0, .board.z=1},
      [0][4][0]={.addr=BOARD_ADDR_04, .board.x=0, .board.y=0, .board.z=0}, [0][4][1]={.addr=BOARD_ADDR_04, .board.x=0, .board.y=0, .board.z=1},
      [0][5][0]={.addr=BOARD_ADDR_70, .board.x=0, .board.y=0, .board.z=0}, [0][5][1]={.addr=BOARD_ADDR_70, .board.x=0, .board.y=0, .board.z=1},
      ...
      [1][3][0]={.addr=BOARD_ADDR_03, .board.x=1, .board.y=0, .board.z=0}, [1][3][1]={.addr=BOARD_ADDR_03, .board.x=1, .board.y=0, .board.z=1},
      [1][4][0]={.addr=BOARD_ADDR_04, .board.x=1, .board.y=0, .board.z=0}, [1][4][1]={.addr=BOARD_ADDR_04, .board.x=1, .board.y=0, .board.z=1},
      [1][5][0]={.addr=BOARD_ADDR_70, .board.x=1, .board.y=0, .board.z=0}, [1][5][1]={.addr=BOARD_ADDR_70, .board.x=1, .board.y=0, .board.z=1},
      ...
      [2][5][0]={.addr=BOARD_ADDR_71, .board.x=0, .board.y=0, .board.z=0}, [2][5][1]={.addr=BOARD_ADDR_71, .board.x=0, .board.y=0, .board.z=1},
      ...
      [3][5][0]={.addr=BOARD_ADDR_71, .board.x=1, .board.y=0, .board.z=0}, [3][5][1]={.addr=BOARD_ADDR_71, .board.x=1, .board.y=0, .board.z=1},
      ...
      [4][5][0]={.addr=BOARD_ADDR_72, .board.x=0, .board.y=0, .board.z=0}, [4][5][1]={.addr=BOARD_ADDR_72, .board.x=0, .board.y=0, .board.z=1},
      ...
      [5][5][0]={.addr=BOARD_ADDR_72, .board.x=1, .board.y=0, .board.z=0}, [5][5][1]={.addr=BOARD_ADDR_72, .board.x=1, .board.y=0, .board.z=1},
      ...
      [6][5][0]={.addr=BOARD_ADDR_73, .board.x=0, .board.y=0, .board.z=0}, [6][5][1]={.addr=BOARD_ADDR_73, .board.x=0, .board.y=0, .board.z=1},
      ...
      [7][5][0]={.addr=BOARD_ADDR_73, .board.x=1, .board.y=0, .board.z=0}, [7][5][1]={.addr=BOARD_ADDR_73, .board.x=1, .board.y=0, .board.z=1},
      ...
      [8][5][0]={.addr=BOARD_ADDR_74, .board.x=0, .board.y=0, .board.z=0}, [8][5][1]={.addr=BOARD_ADDR_74, .board.x=0, .board.y=0, .board.z=1},
      ...
      [9][5][0]={.addr=BOARD_ADDR_74, .board.x=1, .board.y=0, .board.z=0}, [9][5][1]={.addr=BOARD_ADDR_74, .board.x=1, .board.y=0, .board.z=1},
      ...
      [10][5][0]={.addr=BOARD_ADDR_75, .board.x=0, .board.y=0, .board.z=0},[10][5][1]={.addr=BOARD_ADDR_75, .board.x=0, .board.y=0, .board.z=1},
      ...
      [11][5][0]={.addr=BOARD_ADDR_75, .board.x=1, .board.y=0, .board.z=0},[11][5][1]={.addr=BOARD_ADDR_75, .board.x=1, .board.y=0, .board.z=1},
    };
    ...
    MATRIX_BoardList_t MATRIX_BoardList[MATRIX_NOF_BOARDS] = {
        ...
        {.addr=BOARD_ADDR_03, .cmdSent=false},
        {.addr=BOARD_ADDR_04, .cmdSent=false},
        {.addr=BOARD_ADDR_70, .cmdSent=false, .disabled=true},
        ...
        {.addr=BOARD_ADDR_08, .cmdSent=false},
        {.addr=BOARD_ADDR_09, .cmdSent=false},
        {.addr=BOARD_ADDR_71, .cmdSent=false, .disabled=true},
        ...
        {.addr=BOARD_ADDR_13, .cmdSent=false},
        {.addr=BOARD_ADDR_14, .cmdSent=false},
        {.addr=BOARD_ADDR_72, .cmdSent=false, .disabled=true},
        ...
        {.addr=BOARD_ADDR_18, .cmdSent=false},
        {.addr=BOARD_ADDR_19, .cmdSent=false},
        {.addr=BOARD_ADDR_73, .cmdSent=false, .disabled=true},
        ...
        {.addr=BOARD_ADDR_23, .cmdSent=false},
        {.addr=BOARD_ADDR_24, .cmdSent=false},
        {.addr=BOARD_ADDR_74, .cmdSent=false, .disabled=true},
        ...
        {.addr=BOARD_ADDR_28, .cmdSent=false},
        {.addr=BOARD_ADDR_29, .cmdSent=false},
        {.addr=BOARD_ADDR_75, .cmdSent=false, .disabled=true},
