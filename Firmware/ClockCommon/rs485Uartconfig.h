...
/* UART configuration items */
  ...
  #include "fsl_uart.h"
  #define RS485Uart_CONFIG_UART_DEVICE                   UART1
  #define RS485Uart_CONFIG_UART_SET_UART_CLOCK()         /* nothing needed */
  #define RS485Uart_CONFIG_UART_WRITE_BLOCKING           UART_WriteBlocking
  #define RS485Uart_CONFIG_UART_GET_FLAGS                UART_GetStatusFlags
  #define RS485Uart_CONFIG_UART_HW_RX_READY_FLAGS        (kUART_RxDataRegFullFlag|kUART_RxOverrunFlag)
  ...
  #define RS485Uart_CONFIG_UART_GET_DEFAULT_CONFIG       UART_GetDefaultConfig
  #define RS485Uart_CONFIG_UART_ENABLE_INTERRUPTS        UART_EnableInterrupts
  #define RS485Uart_CONFIG_UART_ENABLE_INTERRUPT_FLAGS   (kUART_RxDataRegFullInterruptEnable | kUART_RxOverrunInterruptEnable | kUART_RxFifoOverflowInterruptEnable)
  #define RS485Uart_CONFIG_UART_IRQ_NUMBER               UART1_RX_TX_IRQn
  #define RS485Uart_CONFIG_UART_INIT                     UART_Init
  #define RS485Uart_CONFIG_UART_GET_CLOCK_FREQ_SELECT    kCLOCK_McgFllClk
  #define RS485Uart_CONFIG_UART_IRQ_HANDLER              UART1_RX_TX_IRQHandler
  #define RS485Uart_CONFIG_CLEAR_STATUS_FLAGS            UART_ClearStatusFlags
...
#elif McuLib_CONFIG_CPU_IS_KINETIS
  #define RS485Uart_CONFIG_HAS_FIFO  (1)  /* UART0 on Kinetis has FIFO */
#endif
    ...
    #define RS485Uart_CONFIG_UART_RX_QUEUE_LENGTH        (McuShell_DEFAULT_SHELL_BUFFER_SIZE)
  #endif
  #define RS485Uart_CONFIG_UART_RESPONSE_QUEUE_LENGTH    (32)
#endif
