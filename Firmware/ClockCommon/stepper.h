...
#define STEPPER_NOF_CLOCKS        (PL_CONFIG_NOF_CLOCK_ON_BOARD)      /* number of clocks on a board */
#define STEPPER_NOF_CLOCK_MOTORS  (PL_CONFIG_NOF_CLOCK_ON_BOARD_Z)    /* number of motors for each clock */
