...
#include "McuLog.h"
  ...
  #define MAG0_PORT       PORTA
  #define MAG0_PIN        1U

  #define MAG1_GPIO       GPIOA
  #define MAG1_PORT       PORTA
  #define MAG1_PIN        2U

  #define MAG2_GPIO       GPIOD
  #define MAG2_PORT       PORTD
  #define MAG2_PIN        6U

  #define MAG3_GPIO       GPIOD
  #define MAG3_PORT       PORTD
  #define MAG3_PIN        7U
#elif PL_CONFIG_IS_LPC845
/* Hall_M0: PIO1_1 */
