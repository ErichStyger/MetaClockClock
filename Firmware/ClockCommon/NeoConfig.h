...
#include "platform.h"
  ...
  #define NEOC_NOF_LEDS_IN_COL   (1) /* 8 LEDs for each board */
  #define NEOC_NOF_LEDS_IN_ROW   (8) /* each row/board has 16 LEDs */
  #define NEOC_NOF_LEDS_IN_LANE  (NEOC_NOF_LEDS_IN_COL*NEOC_NOF_LEDS_IN_ROW) /* number of LEDs in a lane */
