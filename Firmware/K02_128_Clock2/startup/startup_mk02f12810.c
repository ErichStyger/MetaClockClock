...
//*****************************************************************************
extern void (* const g_pfnVectors[])(void); // @suppress("Unused variable declaration in file scope")
extern void * __Vectors __attribute__ ((alias ("g_pfnVectors"))); // @suppress("Unused variable declaration in file scope")
...
extern unsigned int __bss_section_table; // @suppress("Unused variable declaration in file scope")
