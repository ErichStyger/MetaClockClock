...
#define NVMC_MININI_FILE_NAME       "settings.ini" /* 'file' name used */
  ...
  /* section for balboa client settings */
  #define NVMC_MININI_SECTION_BALBOA            "Balboa"
  #define NVMC_MININI_KEY_BALBOA_CHANNEL           "channel"   /* uint8_t, channel for RS-485 */
  #define NVMC_MININI_KEY_BALBOA_ON                "on"        /* bool, if RS-485 parsing is enabled */
#endif
