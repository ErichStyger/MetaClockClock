...
//#define PL_SmArtWall (1)

/* select the board used: */
#define PL_CONFIG_BOARD_ID         (PL_CONFIG_BOARD_ID_SMARTWALL_K02FN128)

/* ********************************************************************************************************** */
/* set of available MCUs */
...
#elif PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_CLOCK_K02FN64  || PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_SMARTWALL_K02FN64
  #define PL_CONFIG_BOARD_MCU 		PL_CONFIG_BOARD_ID_MCU_K02FN64
#elif PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_CLOCK_K02FN128  || PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_SMARTWALL_K02FN128
...
/* number of clocks/motors on a single board */
...
#elif PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_SMARTWALL_K02FN64 || PL_CONFIG_BOARD_ID==PL_CONFIG_BOARD_ID_SMARTWALL_K02FN128
  #define PL_CONFIG_NOF_CLOCK_ON_BOARD     (4)  /* temporary on 4, final board as 8! */
  #define PL_CONFIG_NOF_CLOCK_ON_BOARD_X   (4)  /* temporary on 4, final board as 8! */
  #define PL_CONFIG_NOF_CLOCK_ON_BOARD_Y   (1)
